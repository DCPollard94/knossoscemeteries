...
```{r aorist_uncertainty, fig.dim = c(7, 4)}
...
ggplot() + 
  geom_rect(data = rects, aes(xmin = xstart, xmax = xend, ymin = -Inf, ymax = Inf, fill = col), alpha = 0.4) +
     geom_line(data = tombs_gini, aes(decade,gini_coefficient))+
      theme_bw()+theme(legend.title=element_blank(),
          text=element_text(family="Garamond", size=12))+
              labs(x="Date (Years BC)", y="Gini Coefficient")+
                 scale_fill_brewer(palette = "Set3")+ coord_cartesian(
                    xlim = c(1100, 600), ylim = c(0.4,0.8))+ scale_x_reverse(expand = c(0, 0),limits=c(1100,600))
