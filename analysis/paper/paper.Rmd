...
ggarrange(total_import,total_weapon,total_object,importsbyburial,weaponbyburial,objectsbyburial,ncol=3,nrow=2,common.legend = TRUE,legend="bottom")
```
