...
> Pollard, Dominic (2019). _`r Title`_. Name of journal/book <https://doi.org/xxx/xxx>

The pre-print available is online here:

> Pollard, Dominic (2019). _`r Title`_. Name of journal/book, Accessed `r format(Sys.Date(), "%d %b %Y")`. Online at <https://doi.org/xxx/xxx>
